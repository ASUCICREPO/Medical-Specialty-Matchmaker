    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Privacy Notice */}
          <div className="bg-wti-teal bg-opacity-10 border border-wti-teal rounded-lg p-4">
            <h4 className="font-medium text-wti-navy mb-2">Privacy & Security</h4>
            <p className="text-sm text-wti-dark-teal">
              No personally identifiable patient information is collected. All data is anonymized 
              and used solely for matching with appropriate medical specialists.
            </p>
          </div>
