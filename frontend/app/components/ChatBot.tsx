  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2">
      <input
        ...
        disabled={isDisabled}
        className="flex-1 border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed text-gray-900 bg-white"
      />
      <button
        type="submit"
        disabled={isDisabled}
